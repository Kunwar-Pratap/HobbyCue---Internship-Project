    ...
    <footer className="text-gray-600 body-font max-w-screen-xxl mx-auto">
      <div className="md:px-[102px] md:py-[60px] p-6">
        ...
        <div className="flex flex-wrap md:text-left order-first gap-6 md:gap-0">
          ...
          <div className="lg:w-1/4 md:w-1/2 w-full">
            ...
            <nav className="list-none flex flex-col gap-2 md:gap-1">
              {hobbyCue.map((item: TFooterLinks) => (
                <li key={item.id}>
                  <Link href={'#'} className="text-greyHo md:text-sm text-[9px] leading-[18px] font-normal">{item.label}</Link>
                </li>
              ))}
            </nav>
          </div>
          <div className="lg:w-1/4 md:w-1/2 w-full">
            <h2 className="md:text-sm  text-xs leading-[18px] font-bold text-greyHo mb-3">How Do I</h2>
            <nav className="list-none flex flex-col gap-2 md:gap-1">
          ...
          <div className="lg:w-1/4 md:w-1/2 w-full">
            <h2 className="md:text-sm  text-xs leading-[18px] font-bold text-greyHo mb-3">Quick Links</h2>
            <nav className="list-none flex flex-col gap-2 md:gap-1">
