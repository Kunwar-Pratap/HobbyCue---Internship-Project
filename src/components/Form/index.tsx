...
function JoinInForm() {
    return (
        <form className="space-y-4">
            ...
            <div className="inline-flex items-center justify-center w-full relative py-3">
                <hr className="w-full h-[2px]  bg-greyLightHo border-0" />
                <span className="absolute px-2 font-semibold leading-4 text-black -translate-x-1/2 bg-heroHo left-1/2 text-xs">Or connect with</span>
            </div>
            ...
            <div className="relative">
                ...
                <div className="flex justify-between items-center mt-1">
                    <div className='inline-flex gap-2'>
                        <span className="w-[60px] bg-white h-1 inline-block rounded-sm"></span><span className="w-[60px] bg-white h-1 inline-block rounded-sm"></span><span className="w-[60px] bg-white h-1 inline-block rounded-sm"></span>
                    </div>
            ...
            <div className="flex items-center justify-start translate-y-1">
